...
<path d="M12.6668 13.3332H3.3335M4.00016 6.55344C5.0372 5.15117 6.24868 3.89173 7.60395 2.80619C7.72021 2.71306 7.86019 2.6665 8.00016 2.6665M12.0002 6.55344C10.9631 5.15117 9.75164 3.89173 8.39637 2.80619C8.28012 2.71306 8.14014 2.6665 8.00016 2.6665M8.00016 2.6665V10.6665" stroke="#F9D312" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        if (!chatToggleContainer) {
          ...
          const showChatBtn = document.getElementById(
            "show-chat-interface-btn",
          );
          if (showChatBtn) {
        ...
        const createChatToggleButton = () => {
          ...
          const updateButtonState = () => {
            ...
            if (isOpen) {
              ...
              btn.innerHTML = openChatSVG; // Empty SVG when chat is open
              btn.title = "Close Chat";
            } else {
              btn.style.backgroundColor = "#191B1D"; // Keep consistent dark background
              btn.innerHTML = closeChatSVG; // Empty SVG when chat is closed
              btn.title = "Open Chat";
            }
          };

          btn.onclick = () => {
            console.log("Chat toggle button clicked - Main Editor Screen");

            // Always ensure we're on the main editor screen
        ...
        const createUserProfileButton = () => {
          ...
          const reactDropdown = document.createElement(
        ...
        const hideTimelineElements = () => {
          ...
          // Hide other elements but keep chat toggle visible for main editor
          if (leftActionBar) {
          ...
          // Note: chatToggleContainer remains visible for main editor functionality
        };
        ...
        const showTimelineElements = () => {
          ...
          // Ensure chat toggle is always visible on main editor screen
          if (chatToggleContainer) {
